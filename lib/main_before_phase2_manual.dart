                    ...
                    Expanded(
                      child: OutlinedButton.icon(
                        ...
                        style: OutlinedButton.styleFrom(
                          ...
                          side: BorderSide(
                            color:
                                const Color(0xFF9DD6FF).withValues(alpha: 0.4),
                          ),
                        ),
                      ),
                    ),
...
class _DateConverterScreenState extends State<DateConverterScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final bMax = bInfo == null ? 30 : bInfo.end.difference(bInfo.start).inDays + 1;
                    ...
                    child: Row(
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color:
                                const Color(0xFFFFD36E).withValues(alpha: 0.13),
                            borderRadius: BorderRadius.circular(999),
                          ),
                          child: Text(
                            label,
...
class TithiGuideScreen extends StatelessWidget {
  ...
  static const _items = [
    ...
    ['পূর্ণিমা / অমাবস্যা', 'শুক্লপক্ষের শেষ পূর্ণিমা, কৃষ্ণপক্ষের শেষ অমাবস্যা'],
  ];
...
class UpobasInfoScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const items = [
      ...
      ['🌕 পূর্ণিমা', 'অনেকে পূজা, দান বা সংযম পালন করেন; নিয়ম অঞ্চলভেদে বদলায়।'],
      ['🌑 অমাবস্যা', 'তর্পণ/পূজার প্রথা পরিবার ও অঞ্চলের রীতির ওপর নির্ভর করে।'],
      ['🕉️ শিবরাত্রি', 'উপবাস ও রাত্রিজাগরণের প্রচলন আছে; ব্যক্তিগত সামর্থ্য অনুযায়ী পালন করা উচিত।'],
    ];
...
class _TraditionalDayInsight {
  ...
  static _TraditionalDayInsight forDate(DateTime date) {
    ...
    final tithi = PanchangCalculator.tithiFor(sun.sunrise);
    final nak = PanchangCalculator.nakshatraNames[
        PanchangCalculator.nakshatraIndexFor(sun.sunrise)];
    final rashi = PanchangCalculator.rashiNames[
...
class LiveMuhurtaRadarScreen extends StatefulWidget {
  ...
  @override
  State<LiveMuhurtaRadarScreen> createState() =>
      _LiveMuhurtaRadarScreenState();
}
...
class _LiveMuhurtaRadarScreenState extends State<LiveMuhurtaRadarScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final nak = PanchangCalculator.nakshatraNames[
        PanchangCalculator.nakshatraIndexFor(nowReal)];
                ...
                _glass(
                  Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Text(statusIcon, style: const TextStyle(fontSize: 30)),
                          const SizedBox(width: 10),
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
