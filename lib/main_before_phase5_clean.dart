...
class SuperServicesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const signature = [
      ...
      _SuperServiceData('🪔', 'Festival Hub'),
    ];
    ...
    const smart = [
      ...
      _SuperServiceData('⏱️', 'Panchang Timeline'),
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            _section(context, '✨ Signature Super Features', signature),
            _section(context, '🧠 Personal Intelligence', personalSmart),
            _section(context, '⚡ Automation & Habits', automation),
